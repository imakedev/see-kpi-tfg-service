...
{
    public  function validateTemplate($numberOfSheet,$request,$bank_values,$number_values,$all_number_values){
        ...
        foreach ($request->file() as $f) {
            for ($k = 0;$k<$numberOfSheet ; $k++) {
                ...
                Excel::selectSheetsByIndex($k)->load($f, function($reader) use ($all_number_values, $k, $bank_values, $number_values,$structure_name) {
